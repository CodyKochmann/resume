...
- **Cloud Infrastructure:** Led the comprehensive overhaul of the Third-Party Risk Management (TPRM) Azure infrastructure, establishing a mature, highly resilient posture rooted in industry best practices.
...
- Drove the development of the tools and workflows needed to generate ephemeral development environments for engineers to safely perform isolated experiments. 
